...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 w-full bg-white/67 dark:bg-gray-900/65 backdrop-blur-sm shadow-lg z-10 py-4 border-b border-gray-200 dark:border-gray-700">
